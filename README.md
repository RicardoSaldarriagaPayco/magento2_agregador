# Plugin Integración ePayco para Magento 2 (2.x) Agregador
...
## Versiones
* [ePayco plugin Magento v2.4.x](https://github.com/pruebasepayco/magento2_agregador/releases/tag/v2.4).
...
```
git clone https://github.com/pruebasepayco/magento2_agregador.git
```
...
y encontrará el panel de ePayco Agregador para configurarlo.
